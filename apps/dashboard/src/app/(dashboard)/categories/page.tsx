    ...
    return (
      <div className="mx-auto max-w-3xl space-y-8">
        <div className="space-y-3">
          ...
          <div className="h-4 max-w-md animate-pulse rounded bg-zinc-200 dark:bg-zinc-800" />
        </div>
        <div className="wt-panel p-6">
          <div className="mb-6 flex items-center justify-between gap-4 border-b border-zinc-200 pb-4 dark:border-zinc-800">
          ...
          <div className="space-y-3">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="flex gap-3 rounded-xl border border-zinc-200/80 p-4 dark:border-zinc-800"
              >
    ...
    <div className="mx-auto max-w-3xl space-y-8">
      <header className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
        <div className="space-y-2">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-zinc-900 dark:text-zinc-50">Catégories</h1>
          <p className="max-w-lg text-sm leading-relaxed text-stone-600 dark:text-zinc-400">
            L’ordre affiché ici correspond aux onglets dans l’application mobile : le premier élément est l’onglet de
            gauche. Les changements sont enregistrés automatiquement après un déplacement.
          </p>
        </div>
        <button
          type="button"
